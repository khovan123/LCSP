...
- [ ] Retrieve primary legal chunks from approved corpus using structure-first/vectorless methods. (AC: 1)
- [ ] Assemble parent clause/article context and one-hop referenced context with explicit roles. (AC: 2)
- [ ] Persist provenance including reference reason, chunk IDs and corpus version separately per context role. (AC: 3)
...
- Source packet: `docs/developer/story-handbook/6-5-retrieve-primary-parent-and-referenced-context.md`.
...
- docs/implementation-artifacts/6-5-retrieve-primary-parent-and-referenced-context.md
