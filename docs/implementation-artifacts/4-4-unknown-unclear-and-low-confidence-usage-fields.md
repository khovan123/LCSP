...
- [ ] Model explicit UNKNOWN/UNCLEAR/low-confidence states per material usage dimension. (AC: 1)
- [ ] Prevent provider/framework-only evidence from inferring business usage facts. (AC: 2)
- [ ] Explain uncertainty in business-language status/read models. (AC: 3)
...
- Source packet: `docs/developer/story-handbook/4-4-unknown-unclear-and-low-confidence-usage-fields.md`.
...
- docs/implementation-artifacts/4-4-unknown-unclear-and-low-confidence-usage-fields.md
