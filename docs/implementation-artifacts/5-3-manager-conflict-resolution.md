...
- [ ] Provide guided resolution choices, rationale capture and downstream impact preview for each conflict. (AC: 1)
- [ ] Validate stale-version submissions and reject refresh-required decisions. (AC: 2)
- [ ] Persist Manager interpretation as separate reconciliation decision without overwriting evidence. (AC: 3)
...
- Source packet: `docs/developer/story-handbook/5-3-manager-conflict-resolution.md`.
...
- docs/implementation-artifacts/5-3-manager-conflict-resolution.md
