...
- [ ] Keep AIUsageFlow storage/versioning distinct from TechnicalProfile artifacts. (AC: 1)
- [ ] Track declaration and technical source refs separately when both contribute to a claim. (AC: 2)
- [ ] Prevent downstream readers from treating AIUsageFlow as raw scanner evidence or final profile. (AC: 3)
...
- Source packet: `docs/developer/story-handbook/4-2-preserve-technicalprofile-and-aiusageflow-separation.md`.
...
- docs/implementation-artifacts/4-2-preserve-technicalprofile-and-aiusageflow-separation.md
