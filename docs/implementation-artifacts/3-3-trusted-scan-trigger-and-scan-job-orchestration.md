...
- Source packet: `docs/developer/story-handbook/3-3-trusted-scan-trigger-and-scan-job-orchestration.md`.
...
- docs/implementation-artifacts/3-3-trusted-scan-trigger-and-scan-job-orchestration.md
