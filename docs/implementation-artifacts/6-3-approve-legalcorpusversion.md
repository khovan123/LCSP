...
- [ ] Validate parsed corpus candidate and persist approved LegalCorpusVersion metadata. (AC: 1)
- [ ] Block approval on structural, metadata, checksum or provenance errors. (AC: 2)
- [ ] Respect effective/not-yet-effective/superseded status in active retrieval selection. (AC: 3)
...
- Source packet: `docs/developer/story-handbook/6-3-approve-legalcorpusversion.md`.
