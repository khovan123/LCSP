...
- [ ] Implement ingestion of approved legal source URL/file/reference into immutable source snapshot. (AC: 1)
- [ ] Persist source metadata, checksum, operator, retrieval timestamp and ingestion run identity. (AC: 2)
- [ ] Reject retrieval/metadata/checksum failures without creating usable corpus version. (AC: 3)
...
- Source packet: `docs/developer/story-handbook/6-1-ingest-official-legal-source-snapshot.md`.
...
- docs/implementation-artifacts/6-1-ingest-official-legal-source-snapshot.md
