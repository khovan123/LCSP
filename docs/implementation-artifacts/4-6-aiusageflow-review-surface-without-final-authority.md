...
- [ ] Create Manager review surface showing claim summaries, refs, confidence, unknowns and conflict candidates. (AC: 1)
- [ ] Enforce RBAC-scoped view differences for Developers versus Managers. (AC: 2)
- [ ] Keep review state neutral and clearly pre-reconciliation/pre-classification. (AC: 3)
...
- Source packet: `docs/developer/story-handbook/4-6-aiusageflow-review-surface-without-final-authority.md`.
...
- docs/implementation-artifacts/4-6-aiusageflow-review-surface-without-final-authority.md
