...
- [ ] Render final, blocked and degraded classification states with distinct labels and version metadata. (AC: 1)
- [ ] Show cited evidence, provider/model metadata where allowed, and blocker/degraded reasons appropriately. (AC: 2)
- [ ] Ensure reruns create new immutable classification versions surfaced in history. (AC: 3)
...
- Source packet: `docs/developer/story-handbook/7-6-present-classification-blocked-or-degraded-state.md`.
...
- docs/implementation-artifacts/7-6-present-classification-blocked-or-degraded-state.md
