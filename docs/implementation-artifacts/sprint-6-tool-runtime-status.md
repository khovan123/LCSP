...
| `run_ts_js_semantic_analysis`  | IMPLEMENTED_RUNTIME | [ts_js_bridge](/home/khovan/Workplaces/LCSP/deepagents/tools/graph/scanner/ts_js_bridge); verified by `tests/test_ts_js_bridge.py` and routed invocation coverage in `tests/test_scanner_workspace.py`                                                                                                                                                                                                                                                                                                                                                                                                    |
