...
- [ ] Build review surface for verified facts, refs, remaining unknowns and readiness state. (AC: 1)
- [ ] Persist Manager approval/rejection with policy version and audit event. (AC: 2)
- [ ] Gate downstream legal matching on explicit approval plus current version checks. (AC: 3)
...
- Source packet: `docs/developer/story-handbook/5-6-manager-review-and-approval-of-verifiedprofile.md`.
...
- docs/implementation-artifacts/5-6-manager-review-and-approval-of-verifiedprofile.md
