...
| `packages/legal-rag` | Shared legal matching contracts. | contracts, persistence, LLM Gateway. | Retrieval/match DTOs | None directly | legal matching commands/events | `implementation/hybrid-retriever-implementation.md` |
