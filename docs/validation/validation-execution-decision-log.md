...
Only rows with `Status = APPROVED_FOR_EXECUTION` may remove an execution blocker. Phase 4.1.2 records the Project Lead's latest owner confirmation for D-01, D-02, D-04, D-05 and D-06, while keeping D-03 formal legal reliability validation and D-07 fixture release governance blocked where explicit evidence is still missing.
...
| D-04 | A2-b | A2-b scope split | A2-b1 = Pre-Implementation Mapping Design Validation; A2-b2 = Post-Implementation Empirical Scanner Acceptance Validation | Project Lead / Architecture / QA | `DEC-VAL-2026-001`; owner attestation | APPROVED_FOR_EXECUTION | A2-b1 readiness recheck, subject to D-07 fixture release |
| D-04-A2B1 | A2-b | A2-b1 scope | Design validation only; excludes runtime scanner accuracy, parser correctness, AST extraction, cross-module flow, empirical FP/FN, performance and resource consumption | Project Lead / Architecture / QA | `DEC-VAL-2026-001`; owner attestation | APPROVED_FOR_EXECUTION | A2-b1 readiness recheck, subject to D-07 fixture release |
...
| D-07 | A2-b / A3 | Fixture release governance | Fixture owner: Phan Nguyễn Quốc Minh; release process DRAFT -> REVIEW_READY -> APPROVED_FOR_VALIDATION -> RETIRED; SHA-256 after finalized fixture card; fixture approver not explicitly confirmed | QA / Architecture | `DEC-VAL-2026-001`; approver still missing | PENDING_OWNER_CONFIRMATION | A2-b1 fixture-based validation execution |
| D-07-HASH | A2-b / A3 | Fixture hash rule | SHA-256 generated only after fixture card is finalized; 10 finalized fixture cards, reviewer approval and `APPROVED_FOR_VALIDATION` release status required before A2-b1 evidence collection | QA / Architecture | `DEC-VAL-2026-001`; fixture cards not finalized/hashed | PENDING_OWNER_CONFIRMATION | Fixture approval before A2-b1 |
