...
Single source of truth for AIUsageFlow domain behavior, claim-level evidence, uncertainty handling, and mapping eligibility. Runtime flow lives in `docs/developer-execution-blueprints/04-ai-usage-flow-blueprint.md`.
