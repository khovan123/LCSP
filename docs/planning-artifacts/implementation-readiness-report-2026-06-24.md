...
- `UX_DRAFT_CREATED`: UX draft exists but is frozen pending scanner/legal/domain consolidation and rebase before review.
...
2. `UX_DRAFT_CREATED`: UX draft exists for Manager and optional Developer experiences but is frozen pending document consolidation, rebase, approval and story traceability.
