...
1. PBAC guard: `legal-rule-catalog:author` for drafting, `legal-rule-catalog:approve` for approval — distinct actions, distinct actors expected (Internal Legal Operator review separation).
...
| T06 | Actor lacks `legal-rule-catalog:author` | 403 `PBAC_DENIED` |
