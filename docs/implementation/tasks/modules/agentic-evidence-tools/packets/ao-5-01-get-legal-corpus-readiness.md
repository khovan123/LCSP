...
Add contracts in `packages/contracts/src/agentic-evidence`; worker projection/handler under `lcsp-python-workers/src/lcsp_workers/agentic_evidence`; gateway/audit seam under `apps/api/src/modules/evidence`. Authority: tool catalog, AO-5 story, legal source spec.
## 21. Open Questions
