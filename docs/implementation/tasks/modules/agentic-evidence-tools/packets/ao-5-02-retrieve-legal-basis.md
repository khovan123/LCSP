...
Contracts `packages/contracts/src/agentic-evidence`; worker retrieval under `lcsp-python-workers/src/lcsp_workers/legal_corpus`; API evidence gateway. Authority: AO-5, tool catalog, legal source spec.
## 21. Open Questions
