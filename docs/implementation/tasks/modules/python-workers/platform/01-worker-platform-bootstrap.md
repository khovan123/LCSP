...
2. Structured logging: JSON format, `correlation_id` in every log line, no passwords/tokens/secrets/source code.
...
| T06 | Log line has `correlation_id` | Log output inspection |
