...
| NFR-009    | Scoped and deny-by-default PBAC access                                                              | NFR-11                            | CANONICAL_MAPPING | `docs/specs/non-functional-requirements.md`          |
| NFR-010    | Material workflow, auth, PBAC, evidence, conflict, classification and document auditability         | NFR-7                             | CANONICAL_MAPPING | `docs/specs/non-functional-requirements.md`          |
