...
- Canonical FR and NFR values come from `docs/specs/requirements-baseline.md`.
- Legacy `FR-###` and `NFR-###` values remain aliases only.
...
| UC | Name | Status | Canonical FR | BR | Canonical NFR | AC |
| --- | --- | --- | --- | --- | --- | --- |
| UC-M01-01 | Register Account | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-001, BR-002 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M01-02 | Login | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-003 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M01-04 | Setup MFA Using Authenticator App | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-006, BR-011 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M01-05 | Verify MFA Code | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-007, BR-009 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M01-06 | Disable MFA | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-010 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M01-07 | Reset MFA | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-012, BR-013 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M01-08 | Manage Session | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-005 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M01-09 | Reset Password | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-004 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M01-10 | Login With MFA | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-008 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M01-11 | Verify Email | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-074 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M01-12 | Change Password | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-075 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M01-13 | Manage Personal Profile | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-076 | NFR-9, NFR-11 | NO_DIRECT_AC |
| UC-M01-14 | Sign In with OAuth/OIDC | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-086, BR-087, BR-088 | NFR-3 | NO_DIRECT_AC |
| UC-M02-01 | Create Organization | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-014 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M02-02 | Manage Organization Members | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-015 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M02-03 | Assign Manager Role | ACTIVE | NO_ACTIVE_PRD_EQUIVALENT | BR-016 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
| UC-M02-04 | Invite Developer | ACTIVE | FR-E1-2 | BR-017, BR-020 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
...
| UC-M04-04 | Upload Manual Technical Evidence JSON | OUT_OF_SCOPE | FR-E3-3 | BR-034 | NO_ACTIVE_PRD_EQUIVALENT | NO_DIRECT_AC |
...
| UC-M06-02 | Calculate Conflict Score | ACTIVE | FR-E4-2, FR-E5-1, FR-E5-2 | BR-048, BR-085 | NO_ACTIVE_PRD_EQUIVALENT | AC-7, AC-8 |
| UC-M06-03 | Route Conflict to Manager | ACTIVE | FR-E5-3 | BR-072 | NO_ACTIVE_PRD_EQUIVALENT | AC-6 |
...
| UC-M06-07 | Create VerifiedProfile | ACTIVE | FR-E6-1 | BR-045 | NO_ACTIVE_PRD_EQUIVALENT | AC-2, AC-5 |
...
| BR | UC | Legacy FR | Canonical FR | Legacy NFR | Canonical NFR | Resolution |
| --- | --- | --- | --- | --- | --- | --- |
| BR-001 | UC-M01-01 | FR-001 | NO_ACTIVE_PRD_EQUIVALENT | NFR-001 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-002 | UC-M01-01 | FR-001 | NO_ACTIVE_PRD_EQUIVALENT | NFR-001 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-003 | UC-M01-02 | FR-002 | NO_ACTIVE_PRD_EQUIVALENT | NFR-005 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-004 | UC-M01-09 | FR-011 | NO_ACTIVE_PRD_EQUIVALENT | NFR-001 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-005 | UC-M01-08 | FR-010 | NO_ACTIVE_PRD_EQUIVALENT | NFR-004 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-006 | UC-M01-04 | FR-003 | NO_ACTIVE_PRD_EQUIVALENT | NFR-002 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-007 | UC-M01-05 | FR-005 | NO_ACTIVE_PRD_EQUIVALENT | NFR-003 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-008 | UC-M01-10 | FR-006 | NO_ACTIVE_PRD_EQUIVALENT | NFR-003 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-009 | UC-M01-05 | FR-007 | NO_ACTIVE_PRD_EQUIVALENT | NFR-003, NFR-005 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-010 | UC-M01-06 | FR-008 | NO_ACTIVE_PRD_EQUIVALENT | NFR-006 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-011 | UC-M01-04 | FR-004 | NO_ACTIVE_PRD_EQUIVALENT | NFR-002 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-012 | UC-M01-07 | FR-009 | NO_ACTIVE_PRD_EQUIVALENT | NFR-006 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-013 | UC-M01-07 | FR-009 | NO_ACTIVE_PRD_EQUIVALENT | NFR-006 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-014 | UC-M02-01 | FR-012 | NO_ACTIVE_PRD_EQUIVALENT | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-015 | UC-M02-02 | FR-013 | NO_ACTIVE_PRD_EQUIVALENT | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-016 | UC-M02-03 | FR-014 | NO_ACTIVE_PRD_EQUIVALENT | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-017 | UC-M02-04 | FR-015 | FR-E1-2 | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
...
| BR-020 | UC-M02-04 | FR-015 | FR-E1-2 | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-021 | UC-M02-05 | FR-016 | FR-E1-3 | NFR-009 | NFR-11 | RESOLVED |
| BR-022 | UC-M02-06 | FR-017 | FR-E1-3, FR-E1-4 | NFR-009 | NFR-11 | RESOLVED |
| BR-023 | UC-M03-01 | FR-018 | FR-E1-1 | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
...
| BR-034 | UC-M04-04 | FR-027 | FR-E3-3 | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
...
| BR-039 | UC-M05-04 | FR-034 | FR-E4-2 | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-040 | UC-M05-05 | FR-035 | FR-E4-3, FR-E4-4 | NFR-023 | NFR-12 | RESOLVED |
| BR-041 | UC-M06-01 | FR-036 | FR-E5-1 | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
...
| BR-045 | UC-M06-07 | FR-042 | FR-E6-1 | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
...
| BR-048 | UC-M06-02 | FR-037 | FR-E5-2 | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
...
| BR-052 | UC-M04-07 | FR-030 | FR-E3-5, FR-E8-4 | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
...
| BR-072 | UC-M06-03 | FR-038 | FR-E5-3 | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-073 | UC-M07-04 | FR-046 | FR-E6-4 | NFR-011 | NFR-12 | RESOLVED |
| BR-074 | UC-M01-11 | FR-063 | NO_ACTIVE_PRD_EQUIVALENT | NFR-001 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-075 | UC-M01-12 | FR-064 | NO_ACTIVE_PRD_EQUIVALENT | NFR-001 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-076 | UC-M01-13 | FR-065 | NO_ACTIVE_PRD_EQUIVALENT | NFR-008 | NFR-9, NFR-11 | RESOLVED |
...
| BR-085 | UC-M06-02 | FR-037, FR-070 | FR-E4-2, FR-E5-1, FR-E5-2 | None | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-086 | UC-M01-14 | FR-074 | NO_ACTIVE_PRD_EQUIVALENT | NFR-027 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-087 | UC-M01-14 | FR-075 | NO_ACTIVE_PRD_EQUIVALENT | NFR-027, NFR-031 | NO_ACTIVE_PRD_EQUIVALENT | RESOLVED |
| BR-088 | UC-M01-14 | FR-076 | NO_ACTIVE_PRD_EQUIVALENT | NFR-028 | NFR-3 | RESOLVED |
...
| Contradictory FR namespace eliminated | PASS_WITH_GAPS | Legacy FR IDs are aliases only; some aliases have NO_ACTIVE_PRD_EQUIVALENT |
| Contradictory NFR namespace eliminated | PASS_WITH_GAPS | Legacy NFR IDs are aliases only; some aliases have NO_ACTIVE_PRD_EQUIVALENT |
