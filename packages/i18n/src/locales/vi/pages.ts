...
export const viPages = {
  ...
  signUp: {
    ...
    homeAriaLabel: "Trang chủ",
    formTitle: "Tạo tài khoản LCSP",
    formDescription: "Khởi tạo workspace cho tổ chức của bạn.",
    displayNameLabel: "Họ tên",
    displayNameDescription: "Dùng tên mà đội của bạn dễ nhận ra.",
    organizationNameLabel: "Tên tổ chức",
    organizationNameDescription: "Thông tin này tạo workspace cho đội của bạn.",
    emailLabel: "Email công việc",
    emailDescription: "Dùng email bạn sẽ dùng để truy cập LCSP.",
    passwordLabel: "Mật khẩu",
    passwordDescription: "Dùng ít nhất 12 ký tự.",
    confirmPasswordLabel: "Xác nhận mật khẩu",
    confirmPasswordDescription: "Nhập lại đúng mật khẩu ở trên.",
    ...
    errors: {
      ...
      organizationNameRequired: "Nhập tên tổ chức của bạn.",
      emailRequired: "Nhập email công việc của bạn.",
      emailInvalid: "Nhập email công việc hợp lệ.",
