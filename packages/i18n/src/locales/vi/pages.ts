...
export const viPages = {
  ...
  technicalEvidence: {
    ...
    runtimeToolLabels: {
      ...
      getVerifiedProfile: "Đọc hồ sơ đã xác minh",
      compareWizardClaim: "So sánh khai báo wizard",
      reconcileProfileToVerifiedProfile: "Đối soát hồ sơ với hồ sơ xác minh",
      getClassificationBaseline: "Đọc baseline phân loại",
      getGapRequirements: "Đọc yêu cầu gap",
      validateClassificationProposal: "Xác thực đề xuất phân loại",
