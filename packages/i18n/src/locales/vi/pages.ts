...
export const viPages = {
  ...
  readiness: {
    ...
    exportGeneratedTitle: "Wizard Readiness Export đã sẵn sàng",
    exportGeneratedDetail: "Đã tạo bản readiness-only phiên bản {version}.",
    exportBlockedTitle: "Đã chặn readiness export",
    exportBlockedDetail:
      "LCSP đã dừng export vì nội dung có thể bị hiểu là kết luận pháp lý.",
    exportErrorTitle: "Không thể tạo readiness export",
    exportErrorDetail: "Hãy kiểm tra trạng thái readiness và thử lại.",
    exportHistoryTitle: "Lịch sử Wizard Readiness Export",
    exportHistoryLoading: "Đang tải các artifact readiness-only",
    exportHistoryEmpty: "Chưa có readiness export nào được tạo.",
    exportVersionLabel: "Phiên bản {version}",
    exportUnavailable: "Đã chặn tải xuống",
    ...
    unresolvedUnknownsTitle: "Thông tin cần xác minh thêm",
    noUnresolvedUnknowns: "Hiện không có mục chưa rõ nào được ghi nhận.",
    completedSteps: {
    ...
    actions: {
      generateExport: "Tạo readiness export",
      generatingExport: "Đang tạo export",
      downloadExport: "Tải PDF",
      backToWorkspace: "Quay lại workspace",
