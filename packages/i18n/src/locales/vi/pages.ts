...
export const viPages = {
  ...
  artifacts: {
    ...
    tabs: {
      all: "Tất cả",
      yours: "Của bạn",
      shared_with_you: "Được chia sẻ với bạn",
    },
    status: {
      ready: "Sẵn sàng",
      waiting: "Đang chờ",
    ...
    viewer: {
      ...
      pgeVersion: "Phiên bản bằng chứng",
      confirmedContext: "Bối cảnh nghiệp vụ đã xác nhận",
      unknownContext: "Bối cảnh chưa giải quyết hoặc chưa biết",
      confirmed: "Đã xác nhận",
      unknown: "Chưa biết",
      dimensionAiUsage: "Khả năng AI hoặc tự động hóa",
      dimensionOperationalProcess: "Quy trình vận hành hoặc nghiệp vụ",
      dimensionDecisionInfluence: "Hành động hoặc quyết định bị ảnh hưởng",
      dimensionHumanOversight: "Giám sát hoặc phê duyệt của con người",
      dimensionAffectedSubjects: "Đối tượng hoặc quy trình bị ảnh hưởng",
      dimensionDataCategories: "Nhóm dữ liệu và nguồn dữ liệu bên ngoài",
      noStatements: "Chưa có phát biểu bối cảnh nghiệp vụ đã xác nhận.",
      investigationSummary: "Tóm tắt điều tra",
      candidateRules: "Yêu cầu ứng viên",
      selectedRules: "Yêu cầu được chọn",
      investigatedRules: "Yêu cầu đã điều tra",
      pendingRules: "Đang chờ",
      waitingRules: "Chờ thêm ngữ cảnh",
      domainLimitedRules: "Bị giới hạn bởi bằng chứng",
      runtimeFailedRules: "Lỗi runtime",
      executionStatus: "Trạng thái thực thi",
      assessmentOutcome: "Kết quả assessment",
      evidenceQuality: "Chất lượng bằng chứng",
      findings: "Kết quả điều tra",
      evidenceReferences: "Tham chiếu bằng chứng",
      sourceAnchors: "Điểm neo nguồn",
      limitations: "Giới hạn",
      customerContextRequested: "Đã yêu cầu thêm ngữ cảnh khách hàng",
      customerContextResolved: "Ngữ cảnh khách hàng đã được giải quyết",
      yes: "Có",
      no: "Không",
      noRules: "Chưa có chi tiết yêu cầu đã điều tra.",
      inProgress: "Đang thực hiện",
      completed: "Hoàn tất",
      interrupted: "Bị gián đoạn",
      compliant: "Tuân thủ",
      nonCompliant: "Không tuân thủ",
      unknownOutcome: "Chưa xác định",
      evidenceBacked: "Có bằng chứng hỗ trợ",
      insufficientEvidence: "Chưa đủ bằng chứng",
      requirementMet: "Đáp ứng yêu cầu",
      requirementNotMet: "Không đáp ứng yêu cầu",
      unresolved: "Chưa giải quyết / chưa đủ bằng chứng",
      runtimeError: "Lỗi runtime",
      waitingForContext: "Đang chờ ngữ cảnh khách hàng",
      pending: "Đang chờ",
  ...
  appShell: {
    ...
    agentStreamLabels: {
      ...
      scanner: "Scanner",
      engineeringRule: "Engineering rule",
      skill: "Skill",
      model: "Model",
      provenance: "Provenance",
    },
    agentStreamTechnicalDetails: "Chi tiết kỹ thuật",
    agentStreamActivities: {
      repositoryScanStarted: "Bắt đầu quét repository",
      repositoryAnalysisStarted: "Bắt đầu phân tích repository",
      repositoryAnalysisCompleted: "Hoàn tất phân tích repository",
      repositoryAnalysisFailed: "Phân tích repository thất bại",
      scanWorkflowStarted: "Bắt đầu luồng quét repository",
      scanWorkflowCompleted: "Hoàn tất luồng quét repository",
      scanWorkflowFailed: "Luồng quét repository thất bại",
      repositoryAnalysisQueued: "Đã xếp hàng phân tích repository",
      repositoryAnalysisRunning: "Đang phân tích repository",
      repositorySourceDownloading: "Đang tải source repository",
      repositorySourceDownloaded: "Đã tải source repository",
      repositoryWorkspacePreparing: "Đang chuẩn bị workspace phân tích cô lập",
      repositoryWorkspaceReady: "Đã chuẩn bị workspace phân tích cô lập",
      repositoryDeepAnalysis: "Đang phân tích cấu trúc và hành vi repository",
      runtimeProgressConnected: "Đã kết nối tiến độ phân tích trực tiếp",
      runtimeProgress: "Đã cập nhật runtime phân tích repository",
      analysisProgressUpdated: "Đã cập nhật tiến độ phân tích",
      reasoningReviewed: "Đã xem xét reasoning của phân tích",
      modelOutputReviewed: "Đã xem xét kết quả phân tích AI",
      aiAnalysisRunning: "Đang phân tích repository bằng AI",
      aiAnalysisCompleted: "Hoàn tất một bước phân tích AI",
      aiAnalysisFailed: "AI provider không thể hoàn tất bước phân tích này",
      providerFallback: "Đã chuyển sang AI provider dự phòng",
      credentialRotation: "Đã thử credential provider khác",
      repositoryEvidenceInspected: "Đã kiểm tra evidence trong repository",
      engineeringRuleEvaluated: "Đã đánh giá rule về technical evidence",
      analysisSkillApplied: "Đã áp dụng kỹ năng phân tích repository",
      ...
      implementationUpdated: "Đã cập nhật implementation",
      targetedTestsRan: "Đã chạy targeted tests",
      codeQualityValidated: "Đã kiểm tra chất lượng code",
      typeSafetyValidated: "Đã kiểm tra type safety",
      changesCommitted: "Đã commit thay đổi implementation",
      changesPushed: "Đã push thay đổi lên remote repository",
      repositoryToolRan: "Đã chạy công cụ phân tích repository",
      subagentSelected: "Đã chọn agent chuyên biệt để phân tích",
      agentReasoning: "Suy luận của agent",
    ...
    runtimePanelRepository: "Repository",
    runtimePanelProvider: "Nhà cung cấp",
    runtimePanelBranch: "Nhánh",
    runtimePanelPinnedCommit: "Commit đã ghim",
    runtimePanelArtifacts: "Artifacts & evidence",
    ...
    settingsHub: {
      ...
      repositories: {
        ...
        azureDevOpsRepositoryAccessGuidance:
          "Dùng tên tổ chức và personal access token có scope Code (Read).",
        azureDevOpsOrganizationLabel: "Tổ chức",
        azureDevOpsOrganizationPlaceholder:
          "Nhập tên tổ chức Azure DevOps (ví dụ: anhkn7)",
  ...
  assessmentFlow: {
    ...
    graph: {
      title: "Đồ thị bằng chứng của chương trình",
      subtitle: "Snapshot evidence của repository · commit đã pin",
      ready: "Sẵn sàng",
      modulesAnalyzed: "Mô-đun đã phân tích",
      modulesAnalyzedDescription:
        "Các mô-đun canonical duy nhất được đưa vào phân tích repository.",
      codeSymbolsIndexed: "Thành phần mã đã lập chỉ mục",
      codeSymbolsIndexedDescription:
        "Các thành phần mã canonical có thể dùng để truy vết bằng chứng.",
      aiModelInvocations: "Lượt gọi mô hình AI",
      aiModelInvocationsDescription:
        "Các node gọi mô hình AI canonical duy nhất sau khi graph được dedupe.",
      evidenceMappedScope: "Độ phủ bằng chứng kỹ thuật",
      ...
      provenance: "Nguồn gốc bằng chứng",
      finding: "Finding",
      evidenceSource: "Nguồn bằng chứng",
      generated: "Tạo lúc",
      evidenceReference: "Tham chiếu evidence",
      openArtifacts: "Mở danh sách Artifacts",
      noClaims: "Chưa có nhận định nào.",
      unavailable: "Không khả dụng",
      evidenceOverview: "Tổng quan bằng chứng",
      noSelection: "Chọn một node trên graph để xem chi tiết evidence path.",
      incoming: "Chiều vào",
      outgoing: "Chiều ra",
      zoomOut: "Thu nhỏ",
      fitGraph: "Vừa khung",
      ...
      repositoryEvidence: "Bằng chứng từ kho mã",
      legendLabel: "Chú thích",
      selectedNode: "Nút đang chọn",
      relationships: "Các mối quan hệ",
      artifactMetadata: "Artifact · evidence repository",
    },
    interview: {
      thought: "Đã suy nghĩ trong 2 giây",
      readyDescription:
  ...
  technicalEvidence: {
    ...
    reasonLabel: "Lý do",
    valueLabel: "Giá trị",
    semanticRuntimeLabel: "Runtime ngữ nghĩa",
    semanticKindLabel: "Loại",
    semanticStatusLabel: "Trạng thái",
    semanticDurabilityLabel: "Replay",
    semanticCorrelationLabel: "Tương quan",
  ...
  admin: {
    ...
    overview: {
      title: "Tổng quan",
      description:
        "Số liệu thống kê cấp hệ thống về người dùng, đánh giá và phiên bản văn bản luật.",
      periodSelectorAria: "Chọn khoảng thời gian báo cáo",
      ...
      metrics: {
        ...
        totalUsersSubtitle: "+{change} trong {days} ngày qua",
        activeUsers: "Người dùng hoạt động",
        activeUsersSubtitle: "{percentage}% trên tổng tài khoản",
        assessments: "Đánh giá",
        assessmentsSubtitle: "{completed} hoàn thành trong kỳ",
        currentCorpus: "Văn bản luật hiện tại",
        corpusSubtitle: "{sources} nguồn · {rules} quy tắc",
        noCorpus: "Chưa có văn bản luật phát hành",
      },
      assessmentActivity: {
        title: "Hoạt động đánh giá",
        subtitle: "Số đánh giá bắt đầu mỗi ngày · {days} ngày qua",
        completed: "đã hoàn thành",
        emptyTitle: "Không có hoạt động đánh giá",
        emptyDescription:
      ...
      accountStatus: {
        ...
        subtitle: "Phân bố tài khoản hiện tại",
        active: "Đang hoạt động",
        invited: "Đã mời",
        suspended: "Tạm đình chỉ",
        totalAccounts: "{count} tổng tài khoản",
        emptyTitle: "Không có tài khoản",
        emptyDescription: "Không có tài khoản người dùng nào trong hệ thống.",
      },
      recentActivity: {
        title: "Hoạt động quản trị gần đây",
        subtitle: "Các thay đổi được thực hiện bởi quản trị viên.",
        tableAria: "Bảng hoạt động quản trị viên gần đây",
        columns: {
          time: "Thời gian",
          admin: "Quản trị viên",
          action: "Hành động",
        ...
        actions: {
          suspendedAccount: "Tạm đình chỉ tài khoản",
          restoredAccount: "Khôi phục quyền truy cập",
          invitedUser: "Mời người dùng",
          publishedCorpus: "Phát hành văn bản luật",
          discardedDraft: "Hủy bản thảo",
        },
        systemActor: "Hệ thống",
        targets: {
          userAccount: "Tài khoản người dùng",
          newUser: "Người dùng mới",
          corpusDraft: "Bản thảo",
          corpusVersion: "Phiên bản văn bản luật",
          system: "Hệ thống",
        },
        emptyTitle: "Không có hoạt động gần đây",
        emptyDescription: "Chưa có hành động quản trị nào được ghi lại.",
        errorTitle: "Không thể tải hoạt động",
        errorDescription: "Không thể tải danh sách hoạt động quản trị gần đây.",
      },
      corpusStatus: {
        title: "Trạng thái văn bản luật",
        subtitle: "Phiên bản văn bản luật đã phát hành và bản thảo",
        currentLabel: "HIỆN TẠI",
        draftLabel: "BẢN THẢO",
        noPublished: "Chưa có phiên bản phát hành",
        noDraft: "Không có bản thảo đang xử lý",
      },
      loading: "Đang tải thống kê tổng quan...",
      error: "Không thể tải số liệu thống kê tổng quan",
      retry: "Thử lại",
    },
    billing: {
      ...
      exporting: "Đang chuẩn bị báo cáo...",
      exportError: "Không thể xuất báo cáo. Vui lòng thử lại.",
      filters: { all: "Trạng thái: Tất cả" },
      gateways: {
        all: "Cổng: Tất cả",
        sepay: "Cổng: SePay",
        sepayName: "SePay",
      ...
      columns: {
        ...
        webhook: "Webhook",
        status: "Trạng thái",
        received: "Thời điểm nhận",
        action: "Thao tác",
      },
      actions: { view: "Xem", review: "Rà soát", close: "Đóng" },
      orderStatus: {
        credited: "Đã cộng",
        awaiting: "Đang chờ",
        blocked: "Đã chặn",
      ...
      footer:
        "Billing thuộc tài khoản khách hàng (userId). Số liệu prototype là fixture; production lấy số liệu từ ledger, payment và usage đã quyết toán.",
      tableAria: "Bảng thanh toán billing",
      unknownAccount: "Chưa xác định tài khoản",
      unknownOrder: "Chưa liên kết đơn hàng",
      emptyTitle: "Không tìm thấy khoản thanh toán",
      emptyDescription: "Không có bản ghi thanh toán khớp với bộ lọc đã chọn.",
      errorTitle: "Không thể tải dữ liệu billing",
      errorDescription: "Không tải được dữ liệu thanh toán. Vui lòng thử lại.",
      retry: "Thử lại",
      loading: "Đang tải dữ liệu thanh toán",
      status: {
        matched: "Đã khớp",
        unmatched: "Chưa khớp",
        amountMismatch: "Sai số tiền",
        duplicate: "Trùng lặp",
        rejected: "Đã từ chối",
