...
export const viPages = {
  ...
  assessmentFlow: {
    ...
    graph: {
      ...
      edges: "cạnh",
      pinnedNote:
        "Sơ đồ bằng chứng được gắn với snapshot kho mã đã được chấp nhận.",
      noGovernedClaims: "Chưa có governed claim.",
      noOverviewProvenance:
        "Chưa có thêm thông tin nguồn evidence cho phần tổng quan này.",
      topologyTitle: "Sơ đồ thực thi và bằng chứng",
      topologyDescription: "Theo dõi các đường dẫn bằng chứng chính trong hệ thống.",
      legendNode: "Node",
      legendRelationship: "Quan hệ",
      legendInspected: "Đang xem",
      repositoryEvidence: "Bằng chứng kho mã",
      legendLabel: "Chú thích",
      selectedNode: "Node được chọn",
