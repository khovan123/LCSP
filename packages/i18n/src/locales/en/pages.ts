...
export const enPages = {
  ...
  artifacts: {
    ...
    emptyDescription:
      "Create an assessment to start building compliance artifacts.",
    open: "Open",
    ...
    types: {
      ...
      programEvidenceGraph: "Evidence graph",
    ...
    viewer: {
      ...
      unavailable:
        "This artifact is not available for the current assessment state.",
      generated: "Generated",
      updated: "Updated",
      revision: "Context revision",
      sourceVersion: "Source version",
      pgeVersion: "Evidence version",
      confirmedContext: "Confirmed business context",
      unknownContext: "Unresolved or unknown context",
      confirmed: "Confirmed",
      unknown: "Unknown",
      dimensionAiUsage: "AI or automated capability",
      dimensionOperationalProcess: "Operational or business process",
      dimensionDecisionInfluence: "Actions or decisions influenced",
      dimensionHumanOversight: "Human oversight or approval",
      dimensionAffectedSubjects: "Affected people or processes",
      dimensionDataCategories: "Data categories and external sources",
      noStatements: "No confirmed business-context statements are available.",
      investigationSummary: "Investigation summary",
      candidateRules: "Candidate requirements",
      selectedRules: "Selected requirements",
      investigatedRules: "Investigated requirements",
      pendingRules: "Pending",
      waitingRules: "Waiting for context",
      domainLimitedRules: "Evidence-limited",
      runtimeFailedRules: "Runtime failures",
      ...
      customerContextRequested: "Additional customer context requested",
      customerContextResolved: "Customer context resolved",
      yes: "Yes",
      no: "No",
      noRules: "No investigated requirement details are available yet.",
      ...
      waitingForContext: "Waiting for customer context",
      pending: "Pending",
  ...
  appShell: {
    ...
    runtimePanelProvider: "Provider",
    runtimePanelBranch: "Branch",
    runtimePanelPinnedCommit: "Pinned commit",
  ...
  workspace: {
    ...
    settingsHub: {
      ...
      billing: {
        ...
        retry: "Retry",
        balanceTitle: "Prepaid balance",
        availableBalance: "Available balance",
        reservedBalance: "Reserved balance",
        topUpTitle: "Top up balance",
        topUpDescription:
          "Create a payment order and transfer the exact VND amount shown below.",
        amountLabel: "Top-up amount (VND)",
        amountPlaceholder: "For example, 100000",
        amountInvalid:
          "Enter a valid VND amount within the allowed range and step.",
        amountHint:
        ...
        paymentDescription:
          "Transfer the order amount using the instructions below. The backend will refresh the payment state.",
        orderAmount: "Order amount",
        orderCredits: "Prepaid credits",
        expiresAt: "Expires",
        createdAt: "Created",
        ...
        copied: "Copied",
        copyPaymentCode: "Copy code",
        pendingPaymentHint:
          "Waiting for the transfer to be detected. This page checks the authoritative payment state.",
        pendingReconciliationTitle: "Payment pending reconciliation",
  ...
  assessmentFlow: {
    ...
    graph: {
      ...
      noSelection: "Select a graph node to inspect its evidence path.",
      incoming: "Incoming",
      outgoing: "Outgoing",
      zoomOut: "Zoom out",
      fitGraph: "Fit graph",
      ...
      edges: "edges",
      pinnedNote:
        "Evidence graph is pinned to the accepted repository snapshot.",
      noGovernedClaims: "No governed claims available yet.",
      noOverviewProvenance:
        "No additional evidence provenance is available for this overview.",
      topologyTitle: "Execution & evidence topology",
      topologyDescription: "Follow the key evidence paths through the system.",
      aiUsageTopologyTitle: "AI usage evidence path",
      ...
      aiUsageRoles: {
        ...
        aiSdk: "AI SDK",
        aiSdkInvocation: "AI SDK call",
        aiApiEndpoint: "REST/API AI endpoint",
        aiGateway: "AI gateway",
        aiProvider: "AI provider",
        modelIdentity: "Model identity",
        configControl: "Config / control",
        unresolvedCandidate: "Unresolved AI candidate",
      },
      evidenceStates: {
        confirmedAiCall: "Confirmed AI call",
        possibleAiCall: "Possible AI call",
        aiProviderReference: "Provider reference",
        unresolvedDynamic: "Unresolved dynamic target",
      },
      resolutionStates: {
        observed: "Observed",
    ...
    postFinding: {
      thought: "Thought for 2s",
      description:
        "Findings are ready. I am coordinating remediation and verification against the pinned repository evidence.",
      codeReviewTitle: "Code review",
      codeReviewPending: "Code review is queued.",
      decisionTitle: "Remediation decision",
      decisionPrompt: "Choose remediation path",
      existingPrTitle: "Existing PR branch",
      existingPrPending: "Waiting for the detected pull request details.",
      createPrTitle: "Create PR branch",
      createPrPending: "Waiting for the remediation pull request.",
      verificationTitle: "Verification",
      verificationPending: "Verification is waiting for remediation output.",
      verificationPassed: "Passed",
      finalTitle: "Final assessment",
      finalSummary:
        "The final Agent turn links the remediation, verification, and final assessment artifacts when they are ready.",
      openPullRequest: "Open pull request",
      pullRequestNumber: "Pull request #{number}",
      pullRequestBranch: "Branch {branch}",
      decisions: {
        UPDATE_GITHUB_PAT: "Update GitHub PAT",
        CONTINUE_DETECTED_PR: "Continue with detected PR",
        CREATE_REMEDIATION_PR: "Create remediation PR",
      },
  ...
  admin: {
    ...
    overview: {
      title: "Overview",
      description:
        "System-level statistics across users, assessments, and corpus versions.",
      periodSelectorAria: "Select reporting period",
      periodLabel: "Period",
      periods: {
        p7d: "Last 7 days",
        p30d: "Last 30 days",
      ...
      metrics: {
        ...
        totalUsersSubtitle: "+{change} in the last {days} days",
        activeUsers: "Active users",
        activeUsersSubtitle: "{percentage}% of all accounts",
        assessments: "Assessments",
        assessmentsSubtitle: "{completed} completed this period",
        currentCorpus: "Current corpus",
        corpusSubtitle: "{sources} sources · {rules} rules",
        noCorpus: "No published corpus",
      },
      assessmentActivity: {
        title: "Assessment activity",
        subtitle: "Assessments started per day · last {days} days",
        completed: "completed",
        emptyTitle: "No assessment activity",
        emptyDescription:
          "There is no assessment activity recorded for the selected period.",
        errorTitle: "Unable to load activity",
        errorDescription:
          "An error occurred while loading assessment activity trends.",
        barTooltip: "{date}: {started} started, {completed} completed",
      },
      accountStatus: {
        ...
        emptyDescription: "No user accounts are registered in the system.",
      },
      recentActivity: {
        title: "Recent admin activity",
        subtitle: "Changes made by administrators.",
        tableAria: "Recent administrator actions table",
        columns: {
          time: "Time",
          admin: "Admin",
          action: "Action",
        ...
        actions: {
          ...
          restoredAccount: "Restored access",
          invitedUser: "Invited user",
          publishedCorpus: "Published corpus",
          discardedDraft: "Discarded draft",
        },
        systemActor: "System",
        targets: {
          userAccount: "User account",
          newUser: "New user",
          corpusDraft: "Corpus draft",
          corpusVersion: "Corpus version",
          system: "System",
        },
        emptyTitle: "No recent activity",
        emptyDescription: "No administrative actions have been recorded yet.",
        errorTitle: "Unable to load activity",
        errorDescription: "Failed to load recent administrative activity.",
      },
      corpusStatus: {
        title: "Corpus status",
        subtitle: "Published and draft corpus versions",
        currentLabel: "CURRENT",
        draftLabel: "DRAFT",
        noPublished: "No published corpus version",
        noDraft: "No active draft version",
      },
      loading: "Loading overview statistics...",
      error: "Unable to load overview statistics",
      retry: "Retry",
    },
    billing: {
      ...
      exportError: "The report could not be exported. Try again.",
      ...
      actions: { view: "View", review: "Review", close: "Close" },
      orderStatus: {
        credited: "Credited",
        awaiting: "Awaiting",
        blocked: "Blocked",
      ...
      footer:
        "Billing is scoped to the customer account (userId). Prototype values are fixtures; production metrics come from settled ledger, payment, and usage facts.",
      tableAria: "Billing payments table",
      unknownAccount: "Account not identified",
      unknownOrder: "Order not linked",
      emptyTitle: "No billing payments found",
      emptyDescription: "No payment records match the selected filter.",
      errorTitle: "Unable to load billing data",
      errorDescription: "Billing data could not be loaded. Try again.",
      retry: "Retry",
