...
export type PagesMessages = {
  ...
  artifacts: {
    ...
    viewer: {
      ...
      confirmed: string;
      unknown: string;
      dimensionAiUsage: string;
      dimensionOperationalProcess: string;
      dimensionDecisionInfluence: string;
      dimensionHumanOversight: string;
      dimensionAffectedSubjects: string;
      dimensionDataCategories: string;
      noStatements: string;
      investigationSummary: string;
      candidateRules: string;
      selectedRules: string;
      investigatedRules: string;
      pendingRules: string;
      waitingRules: string;
      domainLimitedRules: string;
      runtimeFailedRules: string;
      ...
      limitations: string;
      customerContextRequested: string;
      customerContextResolved: string;
      yes: string;
      no: string;
      noRules: string;
      inProgress: string;
  ...
  workspace: {
    ...
    settingsHub: {
      ...
      billing: {
        ...
        paymentCode: string;
        copied: string;
        copyPaymentCode: string;
        pendingPaymentHint: string;
        pendingReconciliationTitle: string;
