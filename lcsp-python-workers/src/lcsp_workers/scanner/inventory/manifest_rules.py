...
def build_manifest_rules() -> list[ManifestRule]:
    return [
        ...
        ManifestRule("pipfile", ("Pipfile",), parse_pipfile),
        ManifestRule("pipfile_lock", ("Pipfile.lock",), parse_pipfile_lock),
        ManifestRule("cargo_toml", ("Cargo.toml",), parse_cargo_toml),
        ManifestRule("env_file", ("*.env", "*.env.example"), parse_env_file),
        ManifestRule("dockerfile", ("Dockerfile",), parse_dockerfile),
