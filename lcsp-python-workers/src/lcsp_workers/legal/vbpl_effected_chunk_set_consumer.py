...
VBPL_EFFECTED_CHUNK_SET_QUEUE = "lcsp.legal-source-vbpl-effected-chunk-set.v1"
...
class VbplEffectedChunkSetConsumer(ConsumerBase):
    queue_name = VBPL_EFFECTED_CHUNK_SET_QUEUE
    routing_key = VBPL_EFFECTED_CHUNK_SET_COMMAND
    requires_pbac = False
