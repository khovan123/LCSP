...
from lcsp_workers.intelligence.conflict_detection_consumer import (
    ConflictDetectionConsumer,
)
from lcsp_workers.intelligence.conflict_detector import ConflictDetector
from lcsp_workers.intelligence.conflict_score_calculator import (
...
def test_consumer_fetches_ai_usage_flow_and_wizard_profile_then_posts_callback() -> None:
    ...
    consumer = ConflictDetectionConsumer(_config(), api_client=api_client)
