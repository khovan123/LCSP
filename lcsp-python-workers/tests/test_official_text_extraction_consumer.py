...
from lcsp_workers.legal.official_text_extraction_consumer import (
    ...
    OFFICIAL_TEXT_EXTRACTION_QUEUE,
...
def test_consumer_extracts_from_snapshot_ref(tmp_path: Path):
    ...
    consumer = OfficialTextExtractionConsumer(
        config,
...
def test_consumer_declares_authoritative_queue_binding():
    assert OfficialTextExtractionConsumer.queue_name == OFFICIAL_TEXT_EXTRACTION_QUEUE
    assert OfficialTextExtractionConsumer.routing_key == OFFICIAL_TEXT_EXTRACTION_COMMAND
