...
export class SaveWizardDraftHandler
  implements ICommandHandler<SaveWizardDraftCommand, SaveWizardDraftResponse>
{
  constructor(
  ...
  async execute(command: SaveWizardDraftCommand): Promise<SaveWizardDraftResponse> {
    const { assessmentId, organizationId, ownerId, answers, correlationId } = command;
