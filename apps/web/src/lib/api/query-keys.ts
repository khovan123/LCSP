...
export const apiQueryKeys = {
  ...
  assessment: {
    ...
    evidenceGraphOverview: (assessmentId: string) =>
  ...
  admin: {
    ...
    billing: (period: string, status: string, page: number, pageSize: number) =>
      ["admin", "billing", period, status, page, pageSize] as const,
