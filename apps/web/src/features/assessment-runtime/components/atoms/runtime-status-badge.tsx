...
const statusLabels: Record<NormalizedWorkflowStepStatus, string> = {
  ...
  [NORMALIZED_WORKFLOW_STEP_STATUSES.running]: resolveAppMessage(
    "pages.appShell.runtimePanelStatuses.running",
  ),
  [NORMALIZED_WORKFLOW_STEP_STATUSES.waiting]: resolveAppMessage(
    "pages.appShell.runtimePanelStatuses.waiting",
  ),
  [NORMALIZED_WORKFLOW_STEP_STATUSES.completed]: resolveAppMessage(
    "pages.appShell.runtimePanelStatuses.completed",
  ),
  [NORMALIZED_WORKFLOW_STEP_STATUSES.skipped]: resolveAppMessage(
    "pages.appShell.runtimePanelStatuses.skipped",
  ),
  [NORMALIZED_WORKFLOW_STEP_STATUSES.failed]: resolveAppMessage(
    "pages.appShell.runtimePanelStatuses.failed",
  ),
