...
from tools.graph.scanner.program_graph.javascript_architecture_resolution import (
...
def test_bullmq_rabbit_and_kafkajs_connect_producer_to_boundary(tmp_path) -> None:
...
boundary.subscribe({ topic: "events" });
boundary.run({ eachMessage: onKafka });
