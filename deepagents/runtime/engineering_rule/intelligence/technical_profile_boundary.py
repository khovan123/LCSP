...
from tools.engineer_rule.investigation.pipeline import (
...
from tools.common.platform.wizard_clarification import (
...
class TechnicalProfileBoundary(AgentBoundaryBase):
    ...
    def handle(self, message: dict, correlationId: str) -> None:
        ...
        import os
        from tools.common.platform.correlation import get_user_id, get_assessment_id
        from tools.common.platform.logging_path import get_partitioned_graph_path
        user_id = get_user_id()
