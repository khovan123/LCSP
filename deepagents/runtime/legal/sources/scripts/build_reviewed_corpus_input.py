...
from tools.legal.legal.reviewed_corpus_input_builder import (
...
def main() -> None:
    ...
    from tools.legal.legal.reviewed_corpus_input_repository import ReviewedCorpusInputRepository
