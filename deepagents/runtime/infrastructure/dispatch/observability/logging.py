...
def _ensure_llm_tool_log_file() -> None:
    ...
    """
    try:
        from tools.common.platform.logging_path import get_llm_tool_log_path
...
class PartitionedLogWriter:
    ...
    def _persist_structured_event(data: dict, rendered_value: str) -> None:
        from tools.common.platform.correlation import get_assessment_id, get_user_id
        from tools.common.platform.logging_path import (
