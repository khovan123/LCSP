...
class ClassificationBoundary(AgentBoundaryBase):
    """Bridge legal-rule-match events into the classification LangGraph flow."""

    boundary_source = "classification.legal-rule-match-ready"
    source_event = "event.legal-rule-match.ready.v1"
    ...
    def handle(self, message: dict, correlationId: str) -> None:
        ...
        Args:
            message: Managed Agent invocation payload.
            correlationId: End-to-end trace identifier for this invocation.
        """
