...
class PendingConflictsExist(RuntimeError):
    """Signal AgentBoundaryBase to defer while reconciliation is still pending."""


class VerifiedProfileBoundary(AgentBoundaryBase):
    ...
    boundary_source = "intelligence.all-conflicts-resolved"
    source_event = "event.reconciliation.all-conflicts-resolved.v1"
    requires_pbac = False
