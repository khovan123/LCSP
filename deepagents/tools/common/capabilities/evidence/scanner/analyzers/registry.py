...
class LanguageAnalyzerRegistry:
    ...
    def default(cls, ts_js_bridge_factory=None) -> "LanguageAnalyzerRegistry":
        from .adapters import CSharpLanguageAdapter, JavaLanguageAdapter, KotlinLanguageAdapter, PythonLanguageAdapter, RubyLanguageAdapter, TsJsLanguageAdapter

        return cls((CSharpLanguageAdapter(), JavaLanguageAdapter(), KotlinLanguageAdapter(), PythonLanguageAdapter(), RubyLanguageAdapter(), TsJsLanguageAdapter(ts_js_bridge_factory)))
