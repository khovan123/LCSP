...
class LanguageAnalyzerRegistry:
    ...
    def default(cls, ts_js_bridge_factory=None) -> "LanguageAnalyzerRegistry":
        from .adapters import CSharpLanguageAdapter, JavaLanguageAdapter, KotlinLanguageAdapter, PhpLanguageAdapter, PythonLanguageAdapter, RubyLanguageAdapter, TsJsLanguageAdapter

        return cls((CSharpLanguageAdapter(), JavaLanguageAdapter(), KotlinLanguageAdapter(), PhpLanguageAdapter(), PythonLanguageAdapter(), RubyLanguageAdapter(), TsJsLanguageAdapter(ts_js_bridge_factory)))
