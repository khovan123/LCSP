...
from tools.common.capabilities.evidence.scanner.dependencies.dependency_fact import PackageDependency, is_ai_package
...
from tools.common.capabilities.evidence.scanner.analyzers.findings.confidence_calculator import (
    calculate_confidence,
)
from tools.common.capabilities.evidence.scanner.analyzers.findings.finding_deduplicator import (
    FindingDeduplicator,
    MergedFindingCandidate,
)
...
from tools.common.capabilities.evidence.scanner.analyzers.findings.signal_fuser import (
    FindingCandidate,
    SignalFuser,
)
