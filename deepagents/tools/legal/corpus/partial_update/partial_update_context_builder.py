...
from tools.legal.corpus.models.partial_update import PartialUpdateContext
from tools.legal.sources.vbpl_effects.vbpl_effect_detector import detect_effects_from_html
