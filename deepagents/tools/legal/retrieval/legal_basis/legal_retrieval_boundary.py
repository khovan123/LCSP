...
from tools.common.capabilities.platform.callback_schemas import LegalRuleMatchCallbackPayload
...
class LegalRetrievalBoundary(AgentBoundaryBase):
    """Evaluate active rules and attach only exact, non-repealed corpus citations."""

    boundary_source = "legal.legal-matching-requested"
    source_event = "command.legal-matching.requested.v1"
    requires_pbac = False
    ...
    def __init__(
        ...
        """Create the boundary with injectable API, evaluator, retriever, and builder."""
