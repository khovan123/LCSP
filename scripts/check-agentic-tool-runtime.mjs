...
const pythonDispatcher = read("deepagents/runtime/evidence/provenance/dispatcher.py");
const programTools = read("deepagents/runtime/evidence/provenance/program_graph_tool_entrypoints.py");
const remediationTools = read("deepagents/runtime/evidence/provenance/remediation_tool_entrypoints.py");
